...
keys_silk_name = "keys_separated_silk"
...
large_hole_w = 11.1
large_hole_h = 7.
large_key_w = large_hole_w-0.8
large_key_h = large_hole_h-0.8

small_hole_w = 9.2
small_hole_h = 6.2
small_key_w = small_hole_w-0.8
small_key_h = small_hole_h-0.8
...
def draw_large_key(ix, iy, k) : 
  ...
  dy = 9.
  draw_key(dx, dy, ix, iy, large_key_w, large_key_h, k, step_x, step_y)
...
def draw_small_key(ix, iy, k) : 
  ...
  dy = 49.
  draw_key(dx, dy, ix, iy, small_key_w, small_key_h, k, step_x, step_y)
