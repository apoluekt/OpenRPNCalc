# Run with
# exec(open("/home/poluekt/cernbox/devel/OpenRPNCalc_spacer2/frame.py").read())
...
def outline() : 
    ...
    circle(center = (center_x - pcb_width/2. + corner_rad, center_y - pcb_height/2. + corner_rad), radius=1.7)
    circle(center = (center_x + pcb_width/2. - corner_rad, center_y - pcb_height/2. + corner_rad), radius=1.7)
    circle(center = (center_x - pcb_width/2. + corner_rad, center_y + pcb_height/2. - corner_rad), radius=1.7)
    circle(center = (center_x + pcb_width/2. - corner_rad, center_y + pcb_height/2. - corner_rad), radius=1.7)
    circle(center = (center_x - pcb_width/2. + corner_rad, center_y), radius=1.7)
    circle(center = (center_x + pcb_width/2. - corner_rad, center_y), radius=1.7)

outline()
rounded_rectangle(center=(center_x, center_y), width = pcb_width - 13., height=pcb_height - 11., radius=1.)
pcbnew.Refresh()
